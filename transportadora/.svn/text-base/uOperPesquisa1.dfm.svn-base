object fOperPesquisa1: TfOperPesquisa1
  Left = 197
  Top = 117
  Width = 743
  Height = 580
  ...
  object DBGrid2: TDBGrid
    ...
    Columns = <
      ...
      item
        Expanded = False
        FieldName = 'SERVICO'
        Title.Caption = '1'#186' Servi'#231'o'
        Width = 120
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'SERVICO1'
        Title.Caption = '2'#186' Servi'#231'o'
        Width = 120
        Visible = True
      end
      item
        Expanded = False
        FieldName = 'SERVICO2'
        Title.Caption = '3'#186' Servi'#231'o'
        Width = 120
        Visible = True
      end
      item
  ...
  object sPalm: TSQLDataSet
    ...
    object sPalmNF: TStringField
      FieldName = 'NF'
      ProviderFlags = [pfInUpdate]
      Size = 15
    end
    object sPalmMODO1: TStringField
      FieldName = 'MODO1'
      Size = 60
    end
    object sPalmMODO2: TStringField
      FieldName = 'MODO2'
      Size = 60
    end
    object sPalmSERVICO1: TStringField
      FieldName = 'SERVICO1'
      Size = 60
    end
    object sPalmSERVICO2: TStringField
      FieldName = 'SERVICO2'
      Size = 60
    end
    object sPalmPLCA: TStringField
      FieldName = 'PLCA'
      Size = 10
    end
  end
  ...
  object cPalm: TClientDataSet
    ...
    object cPalmNF: TStringField
      FieldName = 'NF'
      ProviderFlags = [pfInUpdate]
      Size = 15
    end
    object cPalmMODO1: TStringField
      FieldName = 'MODO1'
      Size = 60
    end
    object cPalmMODO2: TStringField
      FieldName = 'MODO2'
      Size = 60
    end
    object cPalmSERVICO1: TStringField
      FieldName = 'SERVICO1'
      Size = 60
    end
    object cPalmSERVICO2: TStringField
      FieldName = 'SERVICO2'
      Size = 60
    end
    object cPalmPLCA: TStringField
      FieldName = 'PLCA'
      Size = 10
    end
  end
