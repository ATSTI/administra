object DM: TDM
  ...
  object sqlsisAdimin: TSQLConnection
    ...
    Params.Strings = (
      ...
      'BlobSize=-1'
      'CommitRetain=False'
      'Database=C:\home\escola\sge_montessori_artur.fdb'
      'ErrorResourceFile='
      'LocaleCode=0000'
      'Password=xl04pq'
      'RoleName=RoleName'
  ...
  object scds_produto_proc: TSQLDataSet
    CommandText = 
      ...
      '.LOTES   '#13#10'from PRODUTOS prod '#13#10'left outer join ALMOXARIFADO ccu' +
      's '#13#10'on ccus.CODALMOXARIFADO = prod.CODALMOXARIFADO '#13#10'where (PROD' +
      'UTO like :pPROD) or (CODPRODUTO = :CODPRODUTO) '#13#10'or (CODPRO = :C' +
      'ODPRO)'
    MaxBlobSize = -1
    Params = <
      item
