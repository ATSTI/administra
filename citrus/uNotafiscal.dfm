inherited fnotafiscal: Tfnotafiscal
  Left = 0
  Top = 19
  Width = 800
  Height = 555
  ...
  object Label9: TLabel [6]
    ...
    Width = 128
    Height = 13
    Caption = 'Base de C'#225'lculo do ISS/IR'
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  inherited MMJPanel1: TMMJPanel
    ...
    object BitBtn2: TBitBtn
      ...
      Glyph.Data = {
        ...
        685E000903C0C0C0C0C0C0C0C0C0100F5900005507075BE1E2FFC0C0C0C0C0C0
        C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0C0
  ...
  object btnProdutoProcura: TBitBtn [43]
    Left = 416
    Top = 74
    Width = 35
    Height = 26
  ...
  object GroupBox1: TGroupBox [45]
    Left = 0
    Top = 98
    Width = 792
    Height = 64
    Caption = 'Servi'#231'os / M'#227'o de Obra '
    Font.Charset = DEFAULT_CHARSET
    Font.Color = clWindowText
    Font.Height = -11
    Font.Name = 'MS Sans Serif'
  ...
  object RadioButton1: TRadioButton [82]
    Left = 701
    Top = 249
    Width = 84
    Height = 17
  ...
  object dtSrcServ: TDataSource
    DataSet = cds_nf_serv
    Left = 496
    Top = 480
  end
  object sds_nf_serv: TSQLDataSet
    CommandText = 'select * from NOTAFISCAL_SERV where NUMNF = :PNF'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
    ...
    Left = 528
    Top = 480
    object sds_nf_servNUMNF_SERV: TIntegerField
      FieldName = 'NUMNF_SERV'
      ProviderFlags = [pfInWhere, pfInKey]
    end
    object sds_nf_servNUMNF: TIntegerField
      FieldName = 'NUMNF'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servSERVICO1: TStringField
      FieldName = 'SERVICO1'
      ProviderFlags = [pfInUpdate]
      Size = 250
    end
    object sds_nf_servSERVICO2: TStringField
      FieldName = 'SERVICO2'
      ProviderFlags = [pfInUpdate]
      Size = 250
    end
    object sds_nf_servSERVICO3: TStringField
      FieldName = 'SERVICO3'
      ProviderFlags = [pfInUpdate]
      Size = 250
    end
    object sds_nf_servVLRSERV1: TFloatField
      FieldName = 'VLRSERV1'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servVLRSERV2: TFloatField
      FieldName = 'VLRSERV2'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servVLRSERV3: TFloatField
      FieldName = 'VLRSERV3'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servBASE_ISS_IR: TFloatField
      FieldName = 'BASE_ISS_IR'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servISS_NOTA: TFloatField
      FieldName = 'ISS_NOTA'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servISS_PERCENT: TFloatField
      FieldName = 'ISS_PERCENT'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servIR_FONT: TFloatField
      FieldName = 'IR_FONT'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servIR_PERCENT: TFloatField
      FieldName = 'IR_PERCENT'
      ProviderFlags = [pfInUpdate]
    end
    object sds_nf_servTOTAL_SERV: TFloatField
      FieldName = 'TOTAL_SERV'
      ProviderFlags = [pfInUpdate]
    end
  end
  object dsp_nf_serv: TDataSetProvider
    DataSet = sds_nf_serv
    Left = 560
    Top = 480
  end
  object cds_nf_serv: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'dsp_nf_serv'
    Left = 592
    Top = 480
    object cds_nf_servNUMNF: TIntegerField
      FieldName = 'NUMNF'
    end
    object cds_nf_servSERVICO1: TStringField
      FieldName = 'SERVICO1'
      Size = 250
    end
    object cds_nf_servSERVICO2: TStringField
      FieldName = 'SERVICO2'
      Size = 250
    end
    object cds_nf_servSERVICO3: TStringField
      FieldName = 'SERVICO3'
      Size = 250
    end
    object cds_nf_servVLRSERV1: TFloatField
      FieldName = 'VLRSERV1'
      DisplayFormat = ',##0.00'
    end
    object cds_nf_servVLRSERV2: TFloatField
      FieldName = 'VLRSERV2'
      DisplayFormat = ',##0.00'
    end
    object cds_nf_servVLRSERV3: TFloatField
      FieldName = 'VLRSERV3'
      DisplayFormat = ',##0.00'
    end
    object cds_nf_servBASE_ISS_IR: TFloatField
      FieldName = 'BASE_ISS_IR'
      DisplayFormat = ',##0.00'
    end
    object cds_nf_servISS_NOTA: TFloatField
      FieldName = 'ISS_NOTA'
      DisplayFormat = ',##0.00'
    end
    object cds_nf_servISS_PERCENT: TFloatField
      FieldName = 'ISS_PERCENT'
    end
    object cds_nf_servIR_FONT: TFloatField
      FieldName = 'IR_FONT'
      DisplayFormat = ',##0.00'
    end
    object cds_nf_servIR_PERCENT: TFloatField
      FieldName = 'IR_PERCENT'
    end
    object cds_nf_servTOTAL_SERV: TFloatField
      FieldName = 'TOTAL_SERV'
      DisplayFormat = ',##0.00'
    end
    object cds_nf_servNUMNF_SERV: TIntegerField
      FieldName = 'NUMNF_SERV'
    end
  end
  ...
  object sds_Mov_Det: TSQLDataSet
    CommandText = 
      'select  movd.CODDETALHE'#13#10'        ,  movd.CODMOVIMENTO'#13#10'        ,' +
      '  movd.CODPRODUTO'#13#10'        ,  movd.CODPRO'#13#10'        ,  movd.PRODU' +
      'TO'#13#10'        ,  movd.ICMS'#13#10'        ,  movd.PRECO'#13#10'        ,  movd' +
      '.QUANTIDADE'#13#10'        ,  movd.QTDE_ALT'#13#10'        ,  movd.UN '#13#10'    ' +
      '    ,  movd.VALOR_TOTAL'#13#10'        ,  movd.VALTOTAL'#13#10'        ,  mo' +
      'vd.TOTAL_PEDIDO '#13#10'        ,  movd.LOTE '#13#10'from MOVIMENTONF movd '#13 +
      #10'where movd.CODDETALHE = :CODDETALHE or movd.CODMOVIMENTO = :pCO' +
      'DMOV'
    MaxBlobSize = -1
    Params = <
      item
    ...
    object sds_Mov_DetVALOR_TOTAL: TFloatField
    ...
    object sds_Mov_DetTOTAL_PEDIDO: TFloatField
  ...
  object cds_Mov_det: TClientDataSet
    ...
    object cds_Mov_detVALOR_TOTAL: TFloatField
      FieldName = 'VALOR_TOTAL'
      DisplayFormat = ',##0.00'
    end
    ...
    object cds_Mov_detTOTAL_PEDIDO: TFloatField
      FieldName = 'TOTAL_PEDIDO'
      DisplayFormat = ',##0.00'
    end
  ...
  object sds_n: TSQLDataSet
    CommandText = 'select MAX(NUMNF)  '#13#10'AS NOVO_NUMERO '#13#10'from NOTAFISCAL '
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
    Left = 240
    Top = 408
    object sds_nNOVO_NUMERO: TIntegerField
      FieldName = 'NOVO_NUMERO'
      ReadOnly = True
    end
  end
  ...
  object sds_nf: TSQLDataSet
    CommandText = 
      ...
      'i.NOMECLIENTE '#13#10'from NOTAFISCAL nf '#13#10'inner join CFOP nat ON nat.' +
      'CFCOD = nf.CFOP '#13#10'left outer join CLIENTES cli on '#13#10'cli.CODCLIEN' +
      'TE=nf.CODCLIENTE '#13#10' where nf.NUMNF=:pNF'#13#10
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object sds_numero: TSQLDataSet
    CommandText = 
      'select NOTASERIE  '#13#10'AS NOVO_NUMERO  '#13#10'from NOTAFISCAL '#13#10'where NU' +
      'MNF = :pcod'
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 272
    Top = 408
    object sds_numeroNOVO_NUMERO: TStringField
      FieldName = 'NOVO_NUMERO'
      Required = True
      Size = 10
    end
  end
  object cds_nfr: TClientDataSet
    Aggregates = <>
    Params = <
      item
        DataType = ftInteger
    ...
    ProviderName = 'dsp_nfr'
    Left = 664
    Top = 40
    object cds_nfrCODPRODUTO: TIntegerField
      FieldName = 'CODPRODUTO'
      ReadOnly = True
    end
    object cds_nfrQTDE: TFloatField
      FieldName = 'QTDE'
      ReadOnly = True
    end
    object cds_nfrPCO: TFloatField
      FieldName = 'PCO'
      ReadOnly = True
    end
    object cds_nfrUN: TStringField
      FieldName = 'UN'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object cds_nfrVALORTOTAL: TFloatField
      FieldName = 'VALORTOTAL'
      ReadOnly = True
    end
    object cds_nfrPRODUTO: TStringField
      FieldName = 'PRODUTO'
      ReadOnly = True
      Required = True
      Size = 300
    end
    object cds_nfrLOGRADOURO: TStringField
      FieldName = 'LOGRADOURO'
      ReadOnly = True
      Size = 50
    end
    object cds_nfrCIDADE: TStringField
      FieldName = 'CIDADE'
      ReadOnly = True
      Size = 40
    end
    object cds_nfrBAIRRO: TStringField
      FieldName = 'BAIRRO'
      ReadOnly = True
      Size = 30
    end
    object cds_nfrUF: TStringField
      FieldName = 'UF'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object cds_nfrCEP: TStringField
      FieldName = 'CEP'
      ReadOnly = True
      Size = 10
    end
    object cds_nfrDDD: TStringField
      FieldName = 'DDD'
      ReadOnly = True
      Size = 3
    end
    object cds_nfrTELEFONE: TStringField
      FieldName = 'TELEFONE'
      ReadOnly = True
      Size = 9
    end
    object cds_nfrRAZAOSOCIAL: TStringField
      FieldName = 'RAZAOSOCIAL'
      ReadOnly = True
      Required = True
      Size = 50
    end
    object cds_nfrCNPJ: TStringField
      FieldName = 'CNPJ'
      ReadOnly = True
      Size = 18
    end
    object cds_nfrTIPOFIRMA: TSmallintField
      FieldName = 'TIPOFIRMA'
      ReadOnly = True
      Required = True
    end
    object cds_nfrINSCESTADUAL: TStringField
      FieldName = 'INSCESTADUAL'
      ReadOnly = True
      Size = 24
    end
    object cds_nfrCFOP: TStringField
      FieldName = 'CFOP'
      ReadOnly = True
      Size = 30
    end
    object cds_nfrNATUREZA: TStringField
      FieldName = 'NATUREZA'
      ReadOnly = True
      Size = 250
    end
    object cds_nfrQUANTIDADE: TFloatField
      FieldName = 'QUANTIDADE'
      ReadOnly = True
    end
    object cds_nfrMARCA: TStringField
      FieldName = 'MARCA'
      ReadOnly = True
      Size = 10
    end
    object cds_nfrPESOBRUTO: TBCDField
      FieldName = 'PESOBRUTO'
      ReadOnly = True
      Precision = 9
      Size = 2
    end
    object cds_nfrPESOLIQUIDO: TBCDField
      FieldName = 'PESOLIQUIDO'
      ReadOnly = True
      Precision = 9
      Size = 2
    end
    object cds_nfrESPECIE: TStringField
      FieldName = 'ESPECIE'
      ReadOnly = True
    end
    object cds_nfrDTAEMISSAO: TDateField
      FieldName = 'DTAEMISSAO'
      ReadOnly = True
    end
    object cds_nfrDTASAIDA: TDateField
      FieldName = 'DTASAIDA'
      ReadOnly = True
    end
    object cds_nfrHORASAIDA: TTimeField
      FieldName = 'HORASAIDA'
      ReadOnly = True
    end
    object cds_nfrCORPONF1: TStringField
      FieldName = 'CORPONF1'
      ReadOnly = True
      Size = 75
    end
    object cds_nfrCORPONF2: TStringField
      FieldName = 'CORPONF2'
      ReadOnly = True
      Size = 75
    end
    object cds_nfrCORPONF3: TStringField
      FieldName = 'CORPONF3'
      ReadOnly = True
      Size = 75
    end
    object cds_nfrCORPONF4: TStringField
      FieldName = 'CORPONF4'
      ReadOnly = True
      Size = 75
    end
    object cds_nfrCORPONF5: TStringField
      FieldName = 'CORPONF5'
      ReadOnly = True
      Size = 75
    end
    object cds_nfrCORPONF6: TStringField
      FieldName = 'CORPONF6'
      ReadOnly = True
      Size = 75
    end
    object cds_nfrUF_1: TStringField
      FieldName = 'UF_1'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object cds_nfrNUMERO: TStringField
      FieldName = 'NUMERO'
      ReadOnly = True
    end
    object cds_nfrBASE_ICMS: TFloatField
      FieldName = 'BASE_ICMS'
      ReadOnly = True
    end
    object cds_nfrVALOR_ICMS: TFloatField
      FieldName = 'VALOR_ICMS'
      ReadOnly = True
    end
    object cds_nfrBASE_ICMS_SUBST: TFloatField
      FieldName = 'BASE_ICMS_SUBST'
      ReadOnly = True
    end
    object cds_nfrVALOR_ICMS_SUBST: TFloatField
      FieldName = 'VALOR_ICMS_SUBST'
      ReadOnly = True
    end
    object cds_nfrVALOR_PRODUTO: TFloatField
      FieldName = 'VALOR_PRODUTO'
      ReadOnly = True
    end
    object cds_nfrVALOR_FRETE: TFloatField
      FieldName = 'VALOR_FRETE'
      ReadOnly = True
    end
    object cds_nfrVALOR_SEGURO: TFloatField
      FieldName = 'VALOR_SEGURO'
      ReadOnly = True
    end
    object cds_nfrOUTRAS_DESP: TFloatField
      FieldName = 'OUTRAS_DESP'
      ReadOnly = True
    end
    object cds_nfrVALOR_IPI: TFloatField
      FieldName = 'VALOR_IPI'
      ReadOnly = True
    end
    object cds_nfrVALOR_TOTAL_NOTA: TFloatField
      FieldName = 'VALOR_TOTAL_NOTA'
      ReadOnly = True
    end
    object cds_nfrFATURA: TStringField
      FieldName = 'FATURA'
      ReadOnly = True
      Size = 300
    end
    object cds_nfrNOMETRANSP: TStringField
      FieldName = 'NOMETRANSP'
      ReadOnly = True
      Size = 50
    end
    object cds_nfrPLACATRANSP: TStringField
      FieldName = 'PLACATRANSP'
      ReadOnly = True
      Size = 8
    end
    object cds_nfrCNPJ_CPF: TStringField
      FieldName = 'CNPJ_CPF'
      ReadOnly = True
    end
    object cds_nfrEND_TRANSP: TStringField
      FieldName = 'END_TRANSP'
      ReadOnly = True
      Size = 80
    end
    object cds_nfrCIDADE_TRANSP: TStringField
      FieldName = 'CIDADE_TRANSP'
      ReadOnly = True
      Size = 50
    end
    object cds_nfrUF_VEICULO_TRANSP: TStringField
      FieldName = 'UF_VEICULO_TRANSP'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object cds_nfrUF_TRANSP: TStringField
      FieldName = 'UF_TRANSP'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object cds_nfrFRETE: TStringField
      FieldName = 'FRETE'
      ReadOnly = True
      FixedChar = True
      Size = 1
    end
    object cds_nfrINSCRICAOESTADUAL: TStringField
      FieldName = 'INSCRICAOESTADUAL'
      ReadOnly = True
    end
    object cds_nfrSERVICO1: TStringField
      FieldName = 'SERVICO1'
      ReadOnly = True
      Size = 250
    end
    object cds_nfrSERVICO2: TStringField
      FieldName = 'SERVICO2'
      ReadOnly = True
      Size = 250
    end
    object cds_nfrVLRSERV1: TFloatField
      FieldName = 'VLRSERV1'
      ReadOnly = True
    end
    object cds_nfrSERVICO3: TStringField
      FieldName = 'SERVICO3'
      ReadOnly = True
      Size = 250
    end
    object cds_nfrVLRSERV2: TFloatField
      FieldName = 'VLRSERV2'
      ReadOnly = True
    end
    object cds_nfrVLRSERV3: TFloatField
      FieldName = 'VLRSERV3'
      ReadOnly = True
    end
    object cds_nfrBASE_ISS_IR: TFloatField
      FieldName = 'BASE_ISS_IR'
      ReadOnly = True
    end
    object cds_nfrISS_NOTA: TFloatField
      FieldName = 'ISS_NOTA'
      ReadOnly = True
    end
    object cds_nfrIR_FONT: TFloatField
      FieldName = 'IR_FONT'
      ReadOnly = True
    end
    object cds_nfrISS_PERCENT: TFloatField
      FieldName = 'ISS_PERCENT'
      ReadOnly = True
    end
    object cds_nfrIR_PERCENT: TFloatField
      FieldName = 'IR_PERCENT'
      ReadOnly = True
    end
    object cds_nfrTOTAL_SERV: TFloatField
      FieldName = 'TOTAL_SERV'
      ReadOnly = True
    end
  end
  object dsp_nfr: TDataSetProvider
    DataSet = sql_nfr
    Left = 632
    Top = 40
  end
  object sql_nfr: TSQLDataSet
    CommandText = 
      'SELECT     MOV.CODPRODUTO '#13#10'               ,SUM(MOV.QUANTIDADE) ' +
      'AS QTDE '#13#10'               ,SUM(MOV.PRECO) AS PCO '#13#10'              ' +
      ' ,MOV.UN '#13#10'               ,SUM(MOV.QUANTIDADE * MOV.PRECO) AS VA' +
      'LORTOTAL                '#13#10'               ,MOV.PRODUTO '#13#10'        ' +
      ...
      '        ,NOTAF.CFOP'#13#10'              ,NATU.CFNOME AS NATUREZA'#13#10'   ' +
      '          ,NOTAF.QUANTIDADE'#13#10'             ,NOTAF.MARCA'#13#10'        ' +
      '     , NOTAF.PESOBRUTO'#13#10'             , NOTAF.PESOLIQUIDO'#13#10'     ,' +
      ' NOTAF.ESPECIE'#13#10'     , NOTAF.DTAEMISSAO'#13#10'     , NOTAF.DTASAIDA'#13#10 +
      '    , NOTAF.HORASAIDA '#13#10'     , NOTAF.CORPONF1'#13#10'     , NOTAF.CORP' +
      'ONF2'#13#10'     , NOTAF.CORPONF3'#13#10'     , NOTAF.CORPONF4'#13#10'     , NOTAF' +
      '.CORPONF5'#13#10'     , NOTAF.CORPONF6'#13#10'     , NOTAF.UF '#13#10'     , NOTAF' +
      '.NUMERO'#13#10'     ,  NOTAF.BASE_ICMS'#13#10'     ,  NOTAF.VALOR_ICMS'#13#10'    ' +
      ' ,  NOTAF.BASE_ICMS_SUBST'#13#10'     ,  NOTAF.VALOR_ICMS_SUBST'#13#10'     ' +
      ',  NOTAF.VALOR_PRODUTO'#13#10'     ,  NOTAF.VALOR_FRETE'#13#10'     ,  NOTAF' +
      '.VALOR_SEGURO'#13#10'     ,  NOTAF.OUTRAS_DESP'#13#10'     ,  NOTAF.VALOR_IP' +
      'I'#13#10'     ,  NOTAF.VALOR_TOTAL_NOTA'#13#10'     ,  NOTAF.FATURA'#13#10'     , ' +
      'transp.NOMETRANSP'#13#10'     , transp.PLACATRANSP'#13#10'     , transp.CNPJ' +
      '_CPF'#13#10'     , transp.END_TRANSP'#13#10'     , transp.CIDADE_TRANSP'#13#10'   ' +
      '  , transp.UF_VEICULO_TRANSP'#13#10'     , transp.UF_TRANSP'#13#10'     , tr' +
      'ansp.FRETE'#13#10'     , transp.INSCRICAOESTADUAL '#13#10'     , NF_SERV.SER' +
      'VICO1'#13#10'     , NF_SERV.SERVICO2'#13#10'     , NF_SERV.VLRSERV1'#13#10'     , ' +
      'NF_SERV.SERVICO3'#13#10'     , NF_SERV.VLRSERV2'#13#10'     , NF_SERV.VLRSER' +
      'V3'#13#10'     , NF_SERV.BASE_ISS_IR'#13#10'     , NF_SERV.ISS_NOTA'#13#10'     , ' +
      'NF_SERV.IR_FONT'#13#10'     , NF_SERV.ISS_PERCENT'#13#10'     , NF_SERV.IR_P' +
      'ERCENT'#13#10'     , NF_SERV.TOTAL_SERV '#13#10'FROM NOTAFISCAL notaf  '#13#10'INN' +
      'ER JOIN MOVIMENTONF MOV ON MOV.CODMOVIMENTO = notaf.NUMNF '#13#10'INNE' +
      'R JOIN CLIENTES CLI ON CLI.CODCLIENTE = notaf.CODCLIENTE '#13#10'LEFT ' +
      'JOIN  ENDERECOCLIENTE ENDE ON ENDE.CODCLIENTE = CLI.CODCLIENTE '#13 +
      #10'LEFT JOIN TRANSPORTADORA transp  on transp.CODTRANSP = notaf.CO' +
      'DTRANSP '#13#10'inner join CFOP NATU on NATU.CFCOD =  NOTAF.CFOP '#13#10'LEF' +
      'T JOIN NOTAFISCAL_SERV NF_SERV on NF_SERV.NUMNF = notaf.NUMNF '#13#10 +
      'WHERE notaf.NUMNF = :PVENDA GROUP BY   MOV.CODPRODUTO    '#13#10'     ' +
      '          ,MOV.UN  '#13#10'               ,MOV.PRODUTO  '#13#10'            ' +
      '   ,ENDE.LOGRADOURO '#13#10'              ,ENDE.CIDADE '#13#10'             ' +
      ' ,ENDE.BAIRRO '#13#10'              ,ENDE.UF '#13#10'              ,ENDE.CEP' +
      ' '#13#10'              ,ENDE.DDD '#13#10'              ,ENDE.TELEFONE '#13#10'    ' +
      '          ,CLI.RAZAOSOCIAL'#13#10'              ,CLI.CNPJ '#13#10'          ' +
      '   ,CLI.TIPOFIRMA'#13#10'     ,   NOTAF.CFOP'#13#10', NATU.CFNOME'#13#10'     , NO' +
      'TAF.QUANTIDADE'#13#10'     , NOTAF.MARCA'#13#10'     , NOTAF.PESOBRUTO'#13#10'    ' +
      ' , NOTAF.PESOLIQUIDO'#13#10'     , NOTAF.ESPECIE'#13#10'     , NOTAF.DTAEMIS' +
      'SAO'#13#10'     , NOTAF.DTASAIDA'#13#10'     , NOTAF.HORASAIDA'#13#10'     , NOTAF' +
      '.CORPONF1'#13#10'     , NOTAF.CORPONF2'#13#10'     , NOTAF.CORPONF3'#13#10'     , ' +
      'NOTAF.CORPONF4'#13#10'     , NOTAF.CORPONF5'#13#10'     , NOTAF.CORPONF6'#13#10'  ' +
      '   , NOTAF.UF'#13#10', NOTAF.NUMERO'#13#10'     ,  NOTAF.BASE_ICMS'#13#10'     ,  ' +
      'NOTAF.VALOR_ICMS'#13#10'     ,  NOTAF.BASE_ICMS_SUBST'#13#10'     ,  NOTAF.V' +
      'ALOR_ICMS_SUBST'#13#10'     ,  NOTAF.VALOR_PRODUTO'#13#10'     ,  NOTAF.VALO' +
      'R_FRETE'#13#10'     ,  NOTAF.VALOR_SEGURO'#13#10'     ,  NOTAF.OUTRAS_DESP'#13#10 +
      '     ,  NOTAF.VALOR_IPI'#13#10'     ,  NOTAF.VALOR_TOTAL_NOTA'#13#10'     , ' +
      ' NOTAF.FATURA'#13#10'     , transp.NOMETRANSP'#13#10'     , transp.PLACATRAN' +
      'SP'#13#10'     , transp.CNPJ_CPF'#13#10'     , transp.END_TRANSP'#13#10'     , tra' +
      'nsp.CIDADE_TRANSP'#13#10'     , transp.UF_VEICULO_TRANSP'#13#10'     , trans' +
      'p.UF_TRANSP'#13#10'     , transp.FRETE'#13#10'     , transp.INSCRICAOESTADUA' +
      'L , NF_SERV.SERVICO1'#13#10'     , NF_SERV.SERVICO2'#13#10'     , NF_SERV.VL' +
      'RSERV1'#13#10'     , NF_SERV.SERVICO3'#13#10'     , NF_SERV.VLRSERV2'#13#10'     ,' +
      ' NF_SERV.VLRSERV3'#13#10'     , NF_SERV.BASE_ISS_IR'#13#10'     , NF_SERV.IS' +
      'S_NOTA'#13#10'     , NF_SERV.IR_FONT'#13#10'     , NF_SERV.ISS_PERCENT'#13#10'    ' +
      ' , NF_SERV.IR_PERCENT'#13#10'     , NF_SERV.TOTAL_SERV, CLI.INSCESTADU' +
      'AL ;     '
    MaxBlobSize = -1
    Params = <
      item
    ...
    Left = 600
    Top = 40
    object sql_nfrCODPRODUTO: TIntegerField
      FieldName = 'CODPRODUTO'
      ReadOnly = True
    end
    object sql_nfrQTDE: TFloatField
      FieldName = 'QTDE'
      ReadOnly = True
    end
    object sql_nfrPCO: TFloatField
      FieldName = 'PCO'
      ReadOnly = True
    end
    object sql_nfrUN: TStringField
      FieldName = 'UN'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object sql_nfrVALORTOTAL: TFloatField
      FieldName = 'VALORTOTAL'
      ReadOnly = True
    end
    object sql_nfrPRODUTO: TStringField
      FieldName = 'PRODUTO'
      ReadOnly = True
      Required = True
      Size = 300
    end
    object sql_nfrLOGRADOURO: TStringField
      FieldName = 'LOGRADOURO'
      ReadOnly = True
      Size = 50
    end
    object sql_nfrCIDADE: TStringField
      FieldName = 'CIDADE'
      ReadOnly = True
      Size = 40
    end
    object sql_nfrBAIRRO: TStringField
      FieldName = 'BAIRRO'
      ReadOnly = True
      Size = 30
    end
    object sql_nfrUF: TStringField
      FieldName = 'UF'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object sql_nfrCEP: TStringField
      FieldName = 'CEP'
      ReadOnly = True
      Size = 10
    end
    object sql_nfrDDD: TStringField
      FieldName = 'DDD'
      ReadOnly = True
      Size = 3
    end
    object sql_nfrTELEFONE: TStringField
      FieldName = 'TELEFONE'
      ReadOnly = True
      Size = 9
    end
    object sql_nfrRAZAOSOCIAL: TStringField
      FieldName = 'RAZAOSOCIAL'
      ReadOnly = True
      Required = True
      Size = 50
    end
    object sql_nfrCNPJ: TStringField
      FieldName = 'CNPJ'
      ReadOnly = True
      Size = 18
    end
    object sql_nfrTIPOFIRMA: TSmallintField
      FieldName = 'TIPOFIRMA'
      ReadOnly = True
      Required = True
    end
    object sql_nfrINSCESTADUAL: TStringField
      FieldName = 'INSCESTADUAL'
      ReadOnly = True
      Size = 24
    end
    object sql_nfrCFOP: TStringField
      FieldName = 'CFOP'
      ReadOnly = True
      Size = 30
    end
    object sql_nfrNATUREZA: TStringField
      FieldName = 'NATUREZA'
      ReadOnly = True
      Size = 250
    end
    object sql_nfrQUANTIDADE: TFloatField
      FieldName = 'QUANTIDADE'
      ReadOnly = True
    end
    object sql_nfrMARCA: TStringField
      FieldName = 'MARCA'
      ReadOnly = True
      Size = 10
    end
    object sql_nfrPESOBRUTO: TBCDField
      FieldName = 'PESOBRUTO'
      ReadOnly = True
      Precision = 9
      Size = 2
    end
    object sql_nfrPESOLIQUIDO: TBCDField
      FieldName = 'PESOLIQUIDO'
      ReadOnly = True
      Precision = 9
      Size = 2
    end
    object sql_nfrESPECIE: TStringField
      FieldName = 'ESPECIE'
      ReadOnly = True
    end
    object sql_nfrDTAEMISSAO: TDateField
      FieldName = 'DTAEMISSAO'
      ReadOnly = True
    end
    object sql_nfrDTASAIDA: TDateField
      FieldName = 'DTASAIDA'
      ReadOnly = True
    end
    object sql_nfrHORASAIDA: TTimeField
      FieldName = 'HORASAIDA'
      ReadOnly = True
    end
    object sql_nfrCORPONF1: TStringField
      FieldName = 'CORPONF1'
      ReadOnly = True
      Size = 75
    end
    object sql_nfrCORPONF2: TStringField
      FieldName = 'CORPONF2'
      ReadOnly = True
      Size = 75
    end
    object sql_nfrCORPONF3: TStringField
      FieldName = 'CORPONF3'
      ReadOnly = True
      Size = 75
    end
    object sql_nfrCORPONF4: TStringField
      FieldName = 'CORPONF4'
      ReadOnly = True
      Size = 75
    end
    object sql_nfrCORPONF5: TStringField
      FieldName = 'CORPONF5'
      ReadOnly = True
      Size = 75
    end
    object sql_nfrCORPONF6: TStringField
      FieldName = 'CORPONF6'
      ReadOnly = True
      Size = 75
    end
    object sql_nfrUF_1: TStringField
      FieldName = 'UF_1'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object sql_nfrNUMERO: TStringField
      FieldName = 'NUMERO'
      ReadOnly = True
    end
    object sql_nfrBASE_ICMS: TFloatField
      FieldName = 'BASE_ICMS'
      ReadOnly = True
    end
    object sql_nfrVALOR_ICMS: TFloatField
      FieldName = 'VALOR_ICMS'
      ReadOnly = True
    end
    object sql_nfrBASE_ICMS_SUBST: TFloatField
      FieldName = 'BASE_ICMS_SUBST'
      ReadOnly = True
    end
    object sql_nfrVALOR_ICMS_SUBST: TFloatField
      FieldName = 'VALOR_ICMS_SUBST'
      ReadOnly = True
    end
    object sql_nfrVALOR_PRODUTO: TFloatField
      FieldName = 'VALOR_PRODUTO'
      ReadOnly = True
    end
    object sql_nfrVALOR_FRETE: TFloatField
      FieldName = 'VALOR_FRETE'
      ReadOnly = True
    end
    object sql_nfrVALOR_SEGURO: TFloatField
      FieldName = 'VALOR_SEGURO'
      ReadOnly = True
    end
    object sql_nfrOUTRAS_DESP: TFloatField
      FieldName = 'OUTRAS_DESP'
      ReadOnly = True
    end
    object sql_nfrVALOR_IPI: TFloatField
      FieldName = 'VALOR_IPI'
      ReadOnly = True
    end
    object sql_nfrVALOR_TOTAL_NOTA: TFloatField
      FieldName = 'VALOR_TOTAL_NOTA'
      ReadOnly = True
    end
    object sql_nfrFATURA: TStringField
      FieldName = 'FATURA'
      ReadOnly = True
      Size = 300
    end
    object sql_nfrNOMETRANSP: TStringField
      FieldName = 'NOMETRANSP'
      ReadOnly = True
      Size = 50
    end
    object sql_nfrPLACATRANSP: TStringField
      FieldName = 'PLACATRANSP'
      ReadOnly = True
      Size = 8
    end
    object sql_nfrCNPJ_CPF: TStringField
      FieldName = 'CNPJ_CPF'
      ReadOnly = True
    end
    object sql_nfrEND_TRANSP: TStringField
      FieldName = 'END_TRANSP'
      ReadOnly = True
      Size = 80
    end
    object sql_nfrCIDADE_TRANSP: TStringField
      FieldName = 'CIDADE_TRANSP'
      ReadOnly = True
      Size = 50
    end
    object sql_nfrUF_VEICULO_TRANSP: TStringField
      FieldName = 'UF_VEICULO_TRANSP'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object sql_nfrUF_TRANSP: TStringField
      FieldName = 'UF_TRANSP'
      ReadOnly = True
      FixedChar = True
      Size = 2
    end
    object sql_nfrFRETE: TStringField
      FieldName = 'FRETE'
      ReadOnly = True
      FixedChar = True
      Size = 1
    end
    object sql_nfrINSCRICAOESTADUAL: TStringField
      FieldName = 'INSCRICAOESTADUAL'
      ReadOnly = True
    end
    object sql_nfrSERVICO1: TStringField
      FieldName = 'SERVICO1'
      ReadOnly = True
      Size = 250
    end
    object sql_nfrSERVICO2: TStringField
      FieldName = 'SERVICO2'
      ReadOnly = True
      Size = 250
    end
    object sql_nfrVLRSERV1: TFloatField
      FieldName = 'VLRSERV1'
      ReadOnly = True
    end
    object sql_nfrSERVICO3: TStringField
      FieldName = 'SERVICO3'
      ReadOnly = True
      Size = 250
    end
    object sql_nfrVLRSERV2: TFloatField
      FieldName = 'VLRSERV2'
      ReadOnly = True
    end
    object sql_nfrVLRSERV3: TFloatField
      FieldName = 'VLRSERV3'
      ReadOnly = True
    end
    object sql_nfrBASE_ISS_IR: TFloatField
      FieldName = 'BASE_ISS_IR'
      ReadOnly = True
    end
    object sql_nfrISS_NOTA: TFloatField
      FieldName = 'ISS_NOTA'
      ReadOnly = True
    end
    object sql_nfrIR_FONT: TFloatField
      FieldName = 'IR_FONT'
      ReadOnly = True
    end
    object sql_nfrISS_PERCENT: TFloatField
      FieldName = 'ISS_PERCENT'
      ReadOnly = True
    end
    object sql_nfrIR_PERCENT: TFloatField
      FieldName = 'IR_PERCENT'
      ReadOnly = True
    end
    object sql_nfrTOTAL_SERV: TFloatField
      FieldName = 'TOTAL_SERV'
      ReadOnly = True
    end
  end
  ...
  object sdsTransp: TSQLDataSet
    CommandText = 'select * from TRANSPORTADORA '#13#10'where  CODTRANSP = :cod'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
