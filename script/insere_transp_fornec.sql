CREATE OR ALTER TRIGGER INSERE_TRANSP_FORNEC FOR TRANSPORTADORA INACTIVE
AFTER INSERT POSITION 0
AS
  DECLARE VARIABLE CODFORNEC INTEGER;
BEGIN 
  -- 25/02/2015  esta comentada pq dava problema  
  ...
  begin
    ...
    INSERT INTO FORNECEDOR (CODFORNECEDOR, NOMEFORNECEDOR, RAZAOSOCIAL, CONTATO, 
      ...
      :codFornec, new.FANTASIA, new.NOMETRANSP, new.CONTATO, 
