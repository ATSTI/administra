ALTER PROCEDURE  NFE_FATURA( CODVENDA                         INTEGER )
RETURNS ( DATAFATURA                       DATE
        , VALOR                            DOUBLE PRECISION
        , NUMEROFATURA                     VARCHAR( 20 )
        , FORMAPAGAMENTO                   VARCHAR( 1 ) )
AS
...
BEGIN
  ...
  select first 1 prazo, cast(notafiscal as varchar(15)), serie, CODMOVIMENTO, CODCLIENTE, VALOR_FRETE, FORMARECEBIMENTO from venda where codvenda = :codvenda
