...
BEGIN 
    valor = 0;
    --SELECT FIRST 1 VALOR FROM SP_MOV_CAIXAC((:DTAINI-30), (:DTAINI-1), :COD_CAIXA, :CCUSTO, :FORMAPAG) order by dtapagto desc , ordem desc 
    --  INTO :VALOR;
  
    FOR SELECT DTAPAGTO, ORDEM, DESCRICAO, VALORC, VALORD, CONTACONTABIL, CAIXA, CODCONTA, FORMA, N_DOC, COMPENSADO, VALOR
