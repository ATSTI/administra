...
DELETE FROM CATEGORIAPRODUTO WHERE DESCCATEGORIA <> 'P/M/G/GG'^
DELETE FROM FAMILIAPRODUTOS WHERE DESCFAMILIA <> 'FITNESS E CASUAL'^
DELETE FROM MARCA where DESCMARCAS <> 'BODY FOR SURE'^
