create or ALTER PROCEDURE GERA_NF_DEVOLUCAOCOMPRA (
    FORNECEDOR integer,
    DTEMISSAO date,
    DTVCTO date,
    SERIE char(8),
...
begin 
    ...
    from movimento mov 
    where mov.CONTROLE = :codMov and mov.CODNATUREZA = 21
    into :CODNATUREZA;
  ...
  do begin 
    ...
    values (:codMovNovo, 0,  :FORNECEDOR, :codCCusto, :codUser 
        , :codVendedor, :dtEmissao, 0, 21, :codMov);  
  end 
    pesoTotal = 0;
...
*/
  ...
  INSERT INTO NOTAFISCAL (NOTASERIE, NUMNF, NATUREZA, codVenda, codCliente, cfop
    ...
    VALUES (:numero, :codNF, 21, :codVen, :FORNECEDOR, :cfop
