ALTER PROCEDURE  GERA_NF_VENDA( CLIENTE                          INTEGER
                              , DTEMISSAO                        DATE
                              , DTVCTO                           DATE
                              , SERIE                            CHAR( 8 )
                              , NUMERO                           VARCHAR( 7 )
...
*/
     if (pesoUn is null) then 
      ...
      values(gen_id(GENMOVDET, 1), :codMovNovo, :codProduto, :qtde
       , (:preco*(1-(:desconto/100))), :un, :descP, :icms, :valoricms, :cst,  :desconto);  
  ...
  SELECT FIRST 1 cast(ei.DADOSADC1 as varchar(75)), cast(ei.DADOSADC2 as varchar(75)), cast(ei.DADOSADC3 as varchar(75)), cast(ei.DADOSADC4 as varchar(75)), cast(ei.DADOSADC5 as varchar(75)), cast(ei.DADOSADC6 as varchar(75))
