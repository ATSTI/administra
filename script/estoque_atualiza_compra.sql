CREATE or alter TRIGGER estoque_atualiza_compra FOR COMPRA
...
BEGIN
  ...
  into :codp, :ccusto
   do begin   
      ...
      update produtos set ESTOQUEATUAL = :estoque, valorunitarioatual = :preco_compra 
          , precomedio = :preco_custo
