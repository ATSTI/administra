...
BEGIN
  ...
  SELECT First 1 v.DATAVENDA FROM VENDA v, MOVIMENTO m, MOVIMENTODETALHE md 
   ...
   FOR SELECT CODPROD, SALDOINIACUM,  
     ENTRADA, SAIDA, SALDOFIMACUM, PRECOUNIT, VALORVENDA,  CCUSTOS, LOTES, GRUPO, PRECOCOMPRA, PRECOVENDA, PRECOCUSTO, PRODUTO
       ...
       :GRUPO, :PRECOCOMPRA, :PRECOVENDA, :PRECOCUSTO, :PRODUTO 
   do begin     
   end
   Suspend;
END