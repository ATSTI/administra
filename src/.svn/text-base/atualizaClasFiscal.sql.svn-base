...
begin
  ...
  begin
     vIcms = 0;
     vST = 0;
     if ((familia = 'RAÇÃO P/ AVES') or (familia = 'RAÇÃO P/ BOVINOS') or (familia = 'RAÇÃO P/ EQUINOS') or (familia = 'RAÇÃO P/ FELINOS'))  then
         vIcms = 0;
     if ((familia = 'ACESSÓRIOS P/ AVES') or (familia = 'ACESSÓRIOS P/ CANINOS') or (familia = 'ACESSÓRIOS P/ EQUINOS') or (familia = 'AQUARISMO')
         ...
         vIcms = 18;
     if ((familia = 'RAÇÃO P/ AVES') or (familia = 'RAÇÃO P/ BOVINOS') or (familia = 'RAÇÃO P/ EQUINOS')
          or (familia = 'RAÇÃO P/ FELINOS') or (familia = 'FERRAMENTAS E FERRAGENS') or (familia = 'MATERIAIS P/ JARDINAGEM'))  then
         vST = 7;
