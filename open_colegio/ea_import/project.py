...
class project_work(osv.osv):
    ...
    _columns = {
        ...
        'hours_in': fields.float('Ent.'),
        'hours_out': fields.float('Sai.'),
        'feriado': fields.boolean('Fer.', readonly=False),
        'periculosidade': fields.boolean('Per.', readonly=False),
        'retrabalho': fields.boolean('Ret.', readonly=False),
        'justmedica': fields.boolean('J.Méd.', readonly=False),
        'justespecial': fields.boolean('J.Esp.', readonly=False),
        'externo': fields.boolean('S.Ext.', readonly=False, select="1"),
        'sobreaviso': fields.boolean('Sobr.', readonly=False),
        'embarcado': fields.boolean('Emb.', readonly=False),
