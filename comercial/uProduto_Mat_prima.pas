...
type
  TfProduto_Mat_prima = class(TfPai)
    ...
    sdsMtCUSTO: TFloatField;
    cdsMtCUSTO: TFloatField;
    DBEdit4: TDBEdit;
    Label9: TLabel;
    sdsMtCopiaCUSTO: TFloatField;
    cdsMtCopiaCUSTO: TFloatField;
...
uses UDm, ufprocura_prod1, sCtrlResize, ufprocura_prod;
...
begin
  ...
  begin
    ...
    begin
      ...
      cdsMtCUSTO.AsFloat := dm.scds_produto_procPRECOMEDIO.AsFloat;
    end;
  end;
  {buscar o Gen_id}
...
begin
  ...
  try
    ...
    begin
      ...
      cdsMtCUSTO.AsFloat :=  fProcura_prod1.cds_procPRECOMEDIO.AsFloat;
    end;
  finally
    fProcura_prod1.Free;
  end;
  ...
  begin
    ...
    if scds_produto_proc.IsEmpty then begin
      ...
      begin
        ...
        cdsMtCUSTO.AsFloat := scds_produto_procPRECOMEDIO.AsFloat;
      end;
    end;
  end;
end;
...
begin
  ...
  begin
    MessageDlg('Informe o produto que tem a Lista que será copiada.', mtWarning, [mbOK], 0);
    exit;
  end;
  if scds_produto_proc.Active then
    scds_produto_proc.Close;
  ...
  scds_produto_proc.Open;
  if scds_produto_proc.IsEmpty then begin
    MessageDlg('Código não localizado.', mtWarning,
    [mbOk], 0);
    exit;
  end;
  ...
  begin
    ...
    cdsMtCUSTO.asFloat        := cdsMtCopiaCUSTO.asFloat;
