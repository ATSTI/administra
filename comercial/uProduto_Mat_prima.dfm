inherited fProduto_Mat_prima: TfProduto_Mat_prima
  ...
  object DBComboBox2: TDBComboBox [14]
    Left = 670
    Top = 65
    Width = 115
    Height = 21
  ...
  object sdsMt: TSQLDataSet
    CommandText = 
      ...
      '.PRODUTO, pro.CODPRO, mt.TIPOUSO, mt.USAPRECO, mt.CUSTO from MAT' +
      'ERIA_PRIMA mt, PRODUTOS pro where '#13#10'pro.codproduto = mt.codprodm' +
      'p and '#13#10'mt.CODPRODUTO = :PCOD '
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object sdsMtCopia: TSQLDataSet
    ...
    object sdsMtCopiaCUSTO: TFloatField
      FieldName = 'CUSTO'
    end
  end
  ...
  object cdsMtCopia: TClientDataSet
    ...
    object cdsMtCopiaCUSTO: TFloatField
      FieldName = 'CUSTO'
    end
  end
end
