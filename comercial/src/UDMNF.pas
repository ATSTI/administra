...
type
  TDMNF = class(TDataModule)
    ...
    sds_nfII: TFloatField;
    sds_nfBCII: TFloatField;
    sds_nfNOMEXML: TStringField;
    sds_nfNFE_FINNFE: TStringField;
    sds_nfNFE_MODELO: TStringField;
    sds_nfNFE_VERSAO: TStringField;
    sds_nfNFE_DESTOPERACAO: TStringField;
    sds_nfNFE_FORMATODANFE: TStringField;
    sds_nfNFE_TIPOEMISSAO: TStringField;
    sds_nfNFE_INDFINAL: TStringField;
    sds_nfNFE_INDPRES: TStringField;
    sds_nfNFE_TIPO: TStringField;
    cds_nfII: TFloatField;
    cds_nfBCII: TFloatField;
    cds_nfNOMEXML: TStringField;
    cds_nfNFE_FINNFE: TStringField;
    cds_nfNFE_MODELO: TStringField;
    cds_nfNFE_VERSAO: TStringField;
    cds_nfNFE_DESTOPERACAO: TStringField;
    cds_nfNFE_FORMATODANFE: TStringField;
    cds_nfNFE_TIPOEMISSAO: TStringField;
    cds_nfNFE_INDFINAL: TStringField;
    cds_nfNFE_INDPRES: TStringField;
    cds_nfNFE_TIPO: TStringField;
    sds_nf1PROTOCOLOENV: TStringField;
    sds_nf1NUMRECIBO: TStringField;
    sds_nf1PROTOCOLOCANC: TStringField;
    sds_nf1PESOREMESSA: TBCDField;
    sds_nf1NOTAMAE: TIntegerField;
    sds_nf1CCUSTO: TIntegerField;
    sds_nf1IDCOMPLEMENTAR: TStringField;
    sds_nf1XMLNFE: TGraphicField;
    sds_nf1NOMEXML: TStringField;
    sds_nf1INDPAG: TIntegerField;
    sds_nf1VLRTOT_TRIB: TFloatField;
    sds_nf1NFE_FINNFE: TStringField;
    sds_nf1NFE_MODELO: TStringField;
    sds_nf1NFE_VERSAO: TStringField;
    sds_nf1NFE_DESTOPERACAO: TStringField;
    sds_nf1NFE_FORMATODANFE: TStringField;
    sds_nf1NFE_TIPOEMISSAO: TStringField;
    sds_nf1NFE_INDFINAL: TStringField;
    sds_nf1NFE_INDPRES: TStringField;
    sds_nf1NFE_TIPO: TStringField;
    cds_nf1PROTOCOLOENV: TStringField;
    cds_nf1NUMRECIBO: TStringField;
    cds_nf1PROTOCOLOCANC: TStringField;
    cds_nf1PESOREMESSA: TBCDField;
    cds_nf1NOTAMAE: TIntegerField;
    cds_nf1CCUSTO: TIntegerField;
    cds_nf1IDCOMPLEMENTAR: TStringField;
    cds_nf1XMLNFE: TGraphicField;
    cds_nf1NOMEXML: TStringField;
    cds_nf1INDPAG: TIntegerField;
    cds_nf1VLRTOT_TRIB: TFloatField;
    cds_nf1NFE_FINNFE: TStringField;
    cds_nf1NFE_MODELO: TStringField;
    cds_nf1NFE_VERSAO: TStringField;
    cds_nf1NFE_DESTOPERACAO: TStringField;
    cds_nf1NFE_FORMATODANFE: TStringField;
    cds_nf1NFE_TIPOEMISSAO: TStringField;
    cds_nf1NFE_INDFINAL: TStringField;
    cds_nf1NFE_INDPRES: TStringField;
    cds_nf1NFE_TIPO: TStringField;
    sds_Mov_DetVBCUFDEST: TFloatField;
    sds_Mov_DetPFCPUFDEST: TFloatField;
    sds_Mov_DetPICMSUFDEST: TFloatField;
    sds_Mov_DetPICMSINTER: TFloatField;
    sds_Mov_DetPICMSINTERPART: TFloatField;
    sds_Mov_DetVFCPUFDEST: TFloatField;
    sds_Mov_DetVICMSUFDEST: TFloatField;
    sds_Mov_DetVICMSUFREMET: TFloatField;
    cds_Mov_detVBCUFDEST: TFloatField;
    cds_Mov_detPFCPUFDEST: TFloatField;
    cds_Mov_detPICMSUFDEST: TFloatField;
    cds_Mov_detPICMSINTER: TFloatField;
    cds_Mov_detPICMSINTERPART: TFloatField;
    cds_Mov_detVFCPUFDEST: TFloatField;
    cds_Mov_detVICMSUFDEST: TFloatField;
    cds_Mov_detVICMSUFREMET: TFloatField;
    sds_nfCODFISCAL: TStringField;
    cds_nfCODFISCAL: TStringField;
    sds_nf1CODFISCAL: TStringField;
    ...
    sds_Mov_DetPERCIPIDEVOL: TFloatField;
    sds_Mov_DetVALORIPIDEVOL: TFloatField;
    sds_Mov_DetICMS_PST: TFloatField;
    sds_Mov_DetV_B_FCP: TFloatField;
    sds_Mov_DetV_FCP: TFloatField;
    sds_Mov_DetP_FCP: TFloatField;
    sds_Mov_DetV_B_FCPST: TFloatField;
    sds_Mov_DetV_FCPST: TFloatField;
    sds_Mov_DetP_FCPST: TFloatField;
    sds_Mov_DetV_B_FCPSTRET: TFloatField;
    sds_Mov_DetV_FCPSTRET: TFloatField;
    sds_Mov_DetP_FCPSTRET: TFloatField;
    cds_Mov_detPERCIPIDEVOL: TFloatField;
    cds_Mov_detVALORIPIDEVOL: TFloatField;
    cds_Mov_detICMS_PST: TFloatField;
    cds_Mov_detV_B_FCP: TFloatField;
    cds_Mov_detV_FCP: TFloatField;
    cds_Mov_detP_FCP: TFloatField;
    cds_Mov_detV_B_FCPST: TFloatField;
    cds_Mov_detV_FCPST: TFloatField;
    cds_Mov_detP_FCPST: TFloatField;
    cds_Mov_detV_B_FCPSTRET: TFloatField;
    cds_Mov_detV_FCPSTRET: TFloatField;
    cds_Mov_detP_FCPSTRET: TFloatField;
    sds_Mov_DetVBCSTRET: TFloatField;
    sds_Mov_DetVICMSSTRET: TFloatField;
    sds_Mov_DetVBCSTDEST: TFloatField;
    sds_Mov_DetVICMSSTDEST: TFloatField;
    sds_Mov_DetVBFCPUFDEST: TFloatField;
    cds_Mov_detVBCSTRET: TFloatField;
    cds_Mov_detVICMSSTRET: TFloatField;
    ...
    sds_nfV_B_FCPUFDEST: TFloatField;
    sds_nfV_FCP: TFloatField;
    sds_nfV_FCPST: TFloatField;
    sds_nfV_FCPSTRET: TFloatField;
    sds_nfV_IPI_DEVOL: TFloatField;
    sds_nfINTERM_CNPJ: TStringField;
    sds_nfINTERM_PERFIL: TStringField;
    cds_nfV_B_FCPUFDEST: TFloatField;
    cds_nfV_FCP: TFloatField;
    cds_nfV_FCPST: TFloatField;
    cds_nfV_FCPSTRET: TFloatField;
