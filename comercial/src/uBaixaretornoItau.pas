...
type
  TfBaixaretornoItau = class(TForm)
...
var
  fBaixaretornoItau: TfBaixaretornoItau;
...
procedure TfBaixaretornoItau.FormShow(Sender: TObject);
begin
  if cds.Active then
    cds.Close;
...
procedure TfBaixaretornoItau.BitBtn2Click(Sender: TObject);
begin
  close;
end;

procedure TfBaixaretornoItau.BitBtn1Click(Sender: TObject);
begin
