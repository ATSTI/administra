inherited fFuncionario: TfFuncionario
  ...
  object sCargos: TSQLDataSet
    ...
    Left = 96
    Top = 16
    object sCargosCOD_CARGOSFUNCOES: TIntegerField
      FieldName = 'COD_CARGOSFUNCOES'
      Required = True
    end
    object sCargosDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 100
    end
  end
  object sCliente: TSQLDataSet
    CommandText = 
      'select CODCLIENTE, NOMECLIENTE, RAZAOSOCIAL, TIPOFIRMA, SEGMENTO' +
      ', REGIAO, DATACADASTRO, CODUSUARIO, STATUS from CLIENTES '#13#10'where' +
      ' CODCLIENTE = :id'
    MaxBlobSize = -1
    Params = <
      item
  ...
  object dCliente: TDataSetProvider
    DataSet = sCliente
    Left = 184
    Top = 288
  end
  ...
  object dForn: TDataSetProvider
    DataSet = sForn
    Left = 184
    Top = 320
  end
  object sForn: TSQLDataSet
    CommandText = 'select * from FORNECEDOR '#13#10'where CODFORNECEDOR = :id'
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
  ...
  object cForn: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dForn'
    Left = 216
    Top = 320
    object cFornCODFORNECEDOR: TIntegerField
      FieldName = 'CODFORNECEDOR'
      ProviderFlags = [pfInUpdate, pfInKey]
    end
    object cFornNOMEFORNECEDOR: TStringField
      FieldName = 'NOMEFORNECEDOR'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 50
    end
    object cFornRAZAOSOCIAL: TStringField
      FieldName = 'RAZAOSOCIAL'
      ProviderFlags = [pfInUpdate]
      Required = True
      Size = 50
    end
    object cFornCONTATO: TStringField
      FieldName = 'CONTATO'
      ProviderFlags = [pfInUpdate]
      Size = 30
    end
    object cFornTIPOFIRMA: TSmallintField
      FieldName = 'TIPOFIRMA'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object cFornCPF: TStringField
      FieldName = 'CPF'
      ProviderFlags = [pfInUpdate]
      Size = 14
    end
    object cFornCNPJ: TStringField
      FieldName = 'CNPJ'
      ProviderFlags = [pfInUpdate]
      Size = 18
    end
    object cFornINSCESTADUAL: TStringField
      FieldName = 'INSCESTADUAL'
      ProviderFlags = [pfInUpdate]
      Size = 24
    end
    object cFornRG: TStringField
      FieldName = 'RG'
      ProviderFlags = [pfInUpdate]
      Size = 14
    end
    object cFornSEGMENTO: TSmallintField
      FieldName = 'SEGMENTO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object cFornREGIAO: TSmallintField
      FieldName = 'REGIAO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object cFornLIMITECREDITO: TFloatField
      FieldName = 'LIMITECREDITO'
      ProviderFlags = [pfInUpdate]
    end
    object cFornDATACADASTRO: TDateField
      FieldName = 'DATACADASTRO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object cFornCODUSUARIO: TIntegerField
      FieldName = 'CODUSUARIO'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object cFornSTATUS: TSmallintField
      FieldName = 'STATUS'
      ProviderFlags = [pfInUpdate]
      Required = True
    end
    object cFornHOMEPAGE: TStringField
      FieldName = 'HOMEPAGE'
      ProviderFlags = [pfInUpdate]
      Size = 40
    end
    object cFornPRAZOPAGAMENTO: TSmallintField
      FieldName = 'PRAZOPAGAMENTO'
      ProviderFlags = [pfInUpdate]
    end
    object cFornPRAZOENTREGA: TSmallintField
      FieldName = 'PRAZOENTREGA'
      ProviderFlags = [pfInUpdate]
    end
    object cFornCONTA_FORNECEDOR: TStringField
      FieldName = 'CONTA_FORNECEDOR'
      ProviderFlags = [pfInUpdate]
      Size = 15
    end
