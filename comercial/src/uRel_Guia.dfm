object fRel_Guia: TfRel_Guia
  Left = 278
  Top = 180
  Width = 518
  Height = 480
  Caption = 'Relatorio Conhecimento'
  Color = clMoneyGreen
  ...
  object cGuia: TClientDataSet
    ...
    object cGuiaPLACATRANSP: TStringField
      FieldName = 'PLACATRANSP'
      ProviderFlags = []
      Size = 8
    end
    ...
    object cGuiaNOMETRANSP: TStringField
      FieldName = 'NOMETRANSP'
      Size = 50
    end
  end
  object sGuia: TSQLDataSet
    CommandText = 
      'select g.*,'#13#10'           t.CODTRANSP, '#13#10'           t.PLACATRANSP,' +
      ' '#13#10'           t.CIDADE_TRANSP, '#13#10'           t.UF_VEICULO_TRANSP,' +
      #13#10'           t.NOMETRANSP'#13#10'from GUIATRANSPORTE g '#13#10'left outer jo' +
      'in TRANSPORTADORA t on t.CODTRANSP = g.ID_TRANSPORTADORA '#13#10'where' +
      ' ((ID_TRANSPORTADORA = :id) or (:id = 9999999)) '#13#10'and g.DATA bet' +
    ...
    object sGuiaPLACATRANSP: TStringField
      FieldName = 'PLACATRANSP'
      Size = 8
    end
    ...
    object sGuiaNOMETRANSP: TStringField
      FieldName = 'NOMETRANSP'
      Size = 50
    end
  end
