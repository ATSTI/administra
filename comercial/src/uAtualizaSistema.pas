  ...
  begin
    ...
    begin
      try
        ...
        EXECUTADDL('MOVIMENTODETALHE', 'ALIQ_CUPOM', 'CHAR(4)');
      except
      end;
      mudaVersao('3.1.0.8');
    end;
    ...
    begin
      AtualizandoScript('4.6.0.49');
      EXECUTADDL('CLASSIFICACAOFISCALPRODUTO','CST_IBS_CBS','CHAR(3)');
      EXECUTADDL('CLASSIFICACAOFISCALPRODUTO','CCLASSTRIB','CHAR(6)');
      EXECUTADDL('CLASSIFICACAOFISCALPRODUTO','P_IBS','DOUBLE PRECISION');
      EXECUTADDL('CLASSIFICACAOFISCALPRODUTO','P_CBS','DOUBLE PRECISION');
      EXECUTADDL('CLASSIFICACAOFISCALPRODUTO','REDUCAO_IBS','DOUBLE PRECISION');
      EXECUTADDL('CLASSIFICACAOFISCALPRODUTO','REDUCAO_CBS','DOUBLE PRECISION');

      EXECUTADDL('CLASSIFICACAOFISCALNCM','CST_IBS_CBS','CHAR(3)');
      EXECUTADDL('CLASSIFICACAOFISCALNCM','CCLASSTRIB','CHAR(6)');
      EXECUTADDL('CLASSIFICACAOFISCALNCM','P_IBS','DOUBLE PRECISION');
      EXECUTADDL('CLASSIFICACAOFISCALNCM','P_CBS','DOUBLE PRECISION');
      EXECUTADDL('CLASSIFICACAOFISCALNCM','REDUCAO_IBS','DOUBLE PRECISION');
      EXECUTADDL('CLASSIFICACAOFISCALNCM','REDUCAO_CBS','DOUBLE PRECISION');

      EXECUTADDL('ESTADO_ICMS','CST_IBS_CBS','CHAR(3)');
      EXECUTADDL('ESTADO_ICMS','CCLASSTRIB','CHAR(6)');
      EXECUTADDL('ESTADO_ICMS','P_IBS','DOUBLE PRECISION');
      EXECUTADDL('ESTADO_ICMS','P_CBS','DOUBLE PRECISION');
      EXECUTADDL('ESTADO_ICMS','REDUCAO_IBS','DOUBLE PRECISION');
      EXECUTADDL('ESTADO_ICMS','REDUCAO_CBS','DOUBLE PRECISION');

      EXECUTADDL('MOVIMENTODETALHE','CST_IBS_CBS','CHAR(3)');
      EXECUTADDL('MOVIMENTODETALHE','CCLASSTRIB','CHAR(6)');
      EXECUTADDL('MOVIMENTODETALHE','P_IBS','DOUBLE PRECISION');
