...
type
  TDM_MOV = class(TDataModule)
    ...
    s_movdetVALOR_PIS: TFloatField;
    s_movdetVALOR_COFINS: TFloatField;
    s_movdetCODSOLICITACAO: TIntegerField;
    s_movdetII: TFloatField;
    s_movdetBCII: TFloatField;
    s_movdetCSTIPI: TStringField;
    s_movdetCSTPIS: TStringField;
    s_movdetCSTCOFINS: TStringField;
    s_movdetPPIS: TFloatField;
    s_movdetPCOFINS: TFloatField;
    s_movdetPEDIDO: TStringField;
    s_movdetNITEMPED: TIntegerField;
    s_movdetACRESCIMO: TFloatField;
    s_movdetCORTESIA: TStringField;
    s_movdetATENDENTE: TIntegerField;
    s_movdetCOLABORADOR: TIntegerField;
    s_movdetSUITE: TStringField;
    s_movdetFORMARECEBIMENTO: TStringField;
    s_movdetPAGOU: TStringField;
    s_movdetFRETE_BC: TStringField;
    s_movdetDESCONTO_BC: TStringField;
    s_movdetVLRBC_IPI: TFloatField;
    s_movdetVLRBC_PIS: TFloatField;
    s_movdetVLRBC_COFINS: TFloatField;
    s_movdetVLRTOT_TRIB: TFloatField;
    s_movdetORIGEM: TStringField;
    s_movdetNCM: TStringField;
    s_movdetALIQ_CUPOM: TStringField;
    s_movdetVBCUFDEST: TFloatField;
    s_movdetPFCPUFDEST: TFloatField;
    s_movdetPICMSUFDEST: TFloatField;
    s_movdetPICMSINTER: TFloatField;
    s_movdetPICMSINTERPART: TFloatField;
    s_movdetVFCPUFDEST: TFloatField;
    s_movdetVICMSUFDEST: TFloatField;
    s_movdetVICMSUFREMET: TFloatField;
    s_movdetCST_IPI_CENQ: TStringField;
    s_movdetCEST: TStringField;
    c_movdetVALOR_PIS: TFloatField;
    c_movdetVALOR_COFINS: TFloatField;
    c_movdetCODSOLICITACAO: TIntegerField;
    c_movdetII: TFloatField;
    c_movdetBCII: TFloatField;
    c_movdetCSTIPI: TStringField;
    c_movdetCSTPIS: TStringField;
    c_movdetCSTCOFINS: TStringField;
    c_movdetPPIS: TFloatField;
    c_movdetPCOFINS: TFloatField;
    c_movdetPEDIDO: TStringField;
    c_movdetNITEMPED: TIntegerField;
    c_movdetACRESCIMO: TFloatField;
    c_movdetCORTESIA: TStringField;
    c_movdetATENDENTE: TIntegerField;
    c_movdetCOLABORADOR: TIntegerField;
    c_movdetSUITE: TStringField;
    c_movdetFORMARECEBIMENTO: TStringField;
    c_movdetPAGOU: TStringField;
    c_movdetFRETE_BC: TStringField;
    c_movdetDESCONTO_BC: TStringField;
    c_movdetVLRBC_IPI: TFloatField;
    c_movdetVLRBC_PIS: TFloatField;
    c_movdetVLRBC_COFINS: TFloatField;
    c_movdetVLRTOT_TRIB: TFloatField;
    c_movdetORIGEM: TStringField;
    c_movdetNCM: TStringField;
    c_movdetALIQ_CUPOM: TStringField;
    c_movdetVBCUFDEST: TFloatField;
    c_movdetPFCPUFDEST: TFloatField;
    c_movdetPICMSUFDEST: TFloatField;
    c_movdetPICMSINTER: TFloatField;
    c_movdetPICMSINTERPART: TFloatField;
    c_movdetVFCPUFDEST: TFloatField;
    c_movdetVICMSUFDEST: TFloatField;
