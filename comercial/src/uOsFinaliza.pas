...
begin
  // Carlos - comentei aqui em 08/10/13 pra ver se sumia com access violation
...
begin
  ...
  begin
    if  MessageDlg('Confirma o cancelamento da baixa do Titulo : ''' + scdscr_procTITULO.AsSTring + '''',
      mtConfirmation, [mbYes, mbNo],0) = mrNo then exit;
    Try
      if (scdsCr_proc.State in [dsBrowse, dsInactive]) then
        scdsCr_proc.Edit;
