...
// ---------------- Fecha Cupom com Acréscimo ou Desconto ---------------
...
// ----------------- Aumentando a Descrição do Item ---------------------
...
Begin
  ...
  begin
    Caption := 'Leitura da Memória Fiscal por Datas';
...
Begin
  frmRelatorioGerencial.Caption := 'Relatório Gerencial';
...
Begin
  ...
  begin
    Caption := 'Recebimento Não Fiscal';
    Label3.Visible := true;
    Edit3.Visible := true;
    ShowModal;
    free;
...
Begin
  frmUsaComprovanteNaoFiscalVinculado.Caption := 'Usa Comprovante Não Fiscal Vinculado';
...
// **********************************************************************
//               Comandos das Informações da Impressora
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Alíquotas Programadas:' + #13 + #13 + cAliquotas );
End;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Número do Cupom:' + #13 + #13 + cNumeroCupom );
  // Procedure que analisa o retorno da Impressora
  Retorno_Impressora();
End;
...
procedure TfrmPrincipal.RetornodasFormasdePagamento1Click(Sender: TObject);
   var cFormasPagamento : String;
       iConta   : Integer;
Begin
  // reserva 3016 bytes para a variável
...
Begin
  ...
  // função que retorna os departamentos cadastrados
...
Begin
  iFlagsFiscais := 0;
  // função que retorna os flags fiscais
...
Begin
  ...
  // função que retorna o valor de cancelamentos do dia
...
Begin
  ...
  // função que retorna o valor dos descontos
...
Begin
  ...
  // função que retorna o Grande Total
...
Begin
  // Função para autenticação de documentos
...
begin
  // Função para Cancelar a impressão do cheque
...
Begin
  iStatusCheque := 0;
  // função que retorna o status do cheque
...
begin
  with TFormComprovanteVinculado.Create(self) do
  begin
    Caption := 'Abre Comprovante Não Fiscal Vinculado';
...
begin
  ...
  // A função de cancelamento na impressora restaurante é
...
begin
  if Application.MessageBox( 'Será executada a Redução Z, para o Fechamento do Dia.',
                               'Atenção',
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox('O arquivo RETORNO.TXT foi criado com o conteúdo do' + #13 +
                           ' Relatório Tipo 60 ANALÍTICO.', 'Atenção', MB_IconInformation + MB_OK);
end;
...
begin
  ...
  Retorno_Impressora();
  Application.MessageBox('O arquivo RETORNO.TXT foi criado com o conteúdo do' + #13 +
                           ' Relatório Tipo 60 MESTRE.', 'Atenção', MB_IconInformation + MB_OK);
end;
...
begin
  ...
  if copy( sModo,1,1 ) = '1' then
    Application.MessageBox('A Impressora está Truncando.', 'Atenção', MB_IconInformation + MB_OK)
  else
    Application.MessageBox('A Impressora está Arredondando.', 'Atenção', MB_IconInformation + MB_OK);
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( 'Versão do Firmware: ' + sVersao ), 'Atenção', MB_IconInformation + MB_OK)
end;
...
begin
    with TFormProgramaMoeda.Create(self) do
    begin
      Caption := 'Leitura do Valor do Totalizador não Fiscal';
...
begin
  with TFormIniciaFechamento.Create(self) do
  begin
    Caption := 'Acréscimo/Desconto no Item MFD';
    Label2.Visible := true;
    Edit2.Visible := true;
    ShowModal;
    free;
...
begin
  with TFormIniciaFechamento.Create(self) do
  begin
    Caption := 'Acréscimo/Desconto SubTotal MFD';
    Label2.Visible := false;
    Edit2.Visible := false;
    ShowModal;
    free;
...
begin
  ...
  begin
    Caption := 'Cancelamento de Acréscimo/Desconto no Item';
    Label1.Visible := true;
    Edit1.Visible := true;
    ShowModal;
    free;
...
begin
  with TfrmCancelamentoAcrescimoDesconto.Create(self) do
  begin
    Caption := 'Cancelamento de Acréscimo/Desconto no Subtotal';
...
begin
  with TFormCancelItemGenerico.Create(self) do
  begin
    Caption := 'Abre Relatório Gerencial MFD';
    Panel2.BringToFront;
    ShowModal;
    free;
  end;
...
begin
  frmUsaComprovanteNaoFiscalVinculado.Caption := 'Usa Relatório Gerencial MFD';
  frmUsaComprovanteNaoFiscalVinculado.ShowModal;
end;
...
begin
  with TfrmAbreCupomMFD.Create(self) do
  begin
    Caption := 'Abre Recebimento Não Fiscal MFD';
    ShowModal;
    free;
  end;
end;
...
begin
  with TFormComprovanteVinculado.Create(self) do
  begin
    Caption := 'Abre Comprovante Não Fiscal Vinculado MFD';
    Label4.Visible := true;
    Label5.Visible := true;
    Label6.Visible := true;
    Edit4.Visible := true;
...
begin
  with TFormIniciaFechamento.Create(self) do
  begin
    Caption := 'Acréscimo/Desconto em Subtotal de Recebimento Não Fiscal MFD';
    Label2.Visible := false;
    Edit2.Visible := false;
    ShowModal;
    free;
...
begin
  with TfrmCancelamentoAcrescimoDesconto.Create(self) do
  begin
    Caption := 'Cancelamento de Acréscimo/Desconto em Subtotal de Recebimento Não Fiscal';
    Label1.Visible := false;
    Edit1.Visible := false;
    ShowModal;
    free;
...
begin
  with TfrmAbreCupomMFD.Create(self) do
  begin
    Caption := 'Cancela Recebimento Não Fiscal MFD';
    ShowModal;
    free;
  end;
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sComp ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sCNPJ ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sCupom ),'Informações da Impressora',  MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sCont ),'Informações da Impressora',  MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sRel ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sDados ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sDataHora ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  with TFormRecebimento.Create(self) do
  begin
    Caption := 'Recebimento Não Fiscal MFD';
    Label3.Visible := false;
    Edit3.Visible := false;
    ShowModal;
    free;
...
begin
  with TfrmAbreCupomMFD.Create(self) do
  begin
    Caption := 'Estorno Não Fiscal Vinculado MFD';
    ShowModal;
    free;
  end;
end;
...
begin
  with TFormTerminaFechamento.Create(self) do
  begin
    Caption := 'Fecha Recebimento Não Fiscal MFD';
    ShowModal;
    free;
  end;
end;
...
begin
  ...
  begin
    Caption := 'Inicia Fechamento Recebimento Não Fiscal MFD';
    ShowModal;
    free;
  end;
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sInscricaoEstadual ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sInscricaoMunicipal ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  with TFormMemoriaFiscal.Create(self) do
  begin
    Caption := 'Leitura da Memória Fiscal por Datas MFD';
...
begin
  with TFormMemoriaFiscalMFD.Create(self) do
  begin
    Caption := 'Leitura da Memória Fiscal por Reduções MFD';
    optCompleta.Visible := true;
    optSimplificada.Visible := true;
...
begin
  ...
  Retorno_Impressora();
  Application.MessageBox('O arquivo RETORNO.TXT foi criado com o conteúdo do' + #13 +
                         ' Mapa Resumo.', 'Atenção', MB_IconInformation + MB_OK);
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sMarca + ' ' + sModelo + ' ' +  sTipo ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sTempo ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  with TFormTotalizador.Create(self) do     
  begin
    Caption := 'Nomeia Relatório Gerencial MFD';
    ShowModal;
    free;
  end
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sNumeroSerie ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sLivre ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sRed ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sMemoriaLivre ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  ...
  Analisa_iRetorno();
  Retorno_Impressora();
  Application.MessageBox( pchar( sFgto ), 'Informações da Impressora', MB_IconInformation + MB_OK );
end;
...
begin
  with TFormImprimeCheque.Create(self) do
  begin
    Caption := 'Impressão de Cheque MFD';
    Panel2.BringToFront;
    ShowModal;
    free;
  end
...
procedure TfrmPrincipal.LeituradoCMC7doChequeMFD1Click(Sender: TObject);
  var sCMC7: string;
begin
  Application.MessageBox( 'Insira o cheque para a leitura do CMC-7 e clique OK', 'Atenção', MB_IconInformation + MB_OK );
  setlength( sCMC7, 36 );
...
begin
  with TFormMemoriaFiscal.Create(self) do
  begin
    Caption := 'Leitura da Memória Fiscal Serial por Datas MFD';
    optCompleta.Visible := true;
    optSimplificada.Visible := true;
    ShowModal;
    free;
...
begin
  with TFormMemoriaFiscalMFD.Create(self) do
  begin
    Caption := 'Leitura da Memória Fiscal Serial por Reduções MFD';
    optCompleta.Visible := true;
    optSimplificada.Visible := true;
    ShowModal;
    free;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Numero de Operações Não Fiscais: ' + CGC);
  Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Número de Reduções: ' + CGC);
  Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Número de Interveções Técnicas: ' + CGC);
  Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Número de Substituições Proprietário: ' + CGC);
  Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Número do Último Item Vendido: ' + CGC);
  Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Cliche do Proprietário: ' + CGC);
  Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Número do Caixa: ' + CGC);
  Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Número da Loja : ' + CGC);
  Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  ShowMessage( 'Símbolo da Moeda: ' + CGC);
  Retorno_Impressora();
end;
  ...
  for iConta := 1 to 1 do
   ...
   if CGC = '1' then
    ShowMessage( 'Modo Normal !')
      ...
      ShowMessage( 'Modo Interveção Técnica !');
   Retorno_Impressora();
end;
...
Begin
  ...
  Analisa_iRetorno();
  if iTipo = 1 then ShowMessage( 'Impressora fiscal, gaveta, autenticaçao.' );
  if iTipo = 2 then ShowMessage( 'Impressora fiscal, gaveta, cutter.' );
  if iTipo = 3 then ShowMessage( 'Impressora fiscal, presenter, autenticaçao.' );
  if iTipo = 4 then ShowMessage( 'Impressora fiscal, presenter, cutter.' );
  if iTipo = 5 then ShowMessage( 'Impressora bilhete de passagem, gaveta, autenticaçao.' );
  if iTipo = 6 then ShowMessage( 'Impressora bilhete de passagem, gaveta, cutter.' );
  if iTipo = 7 then ShowMessage( 'Impressora bilhete de passagem, presenter, autenticaçao.' );
...
begin
  frmRelatorioGerencial.Caption := 'Relatório Gerencial TEF';
  frmRelatorioGerencial.ShowModal;
end;

procedure TfrmPrincipal.UsaRelatorioGerencialMFDTEFClick(Sender: TObject);
begin
  frmUsaComprovanteNaoFiscalVinculado.Caption := 'Usa Relatório Gerencial MFD TEF';
  frmUsaComprovanteNaoFiscalVinculado.ShowModal;
end;
...
procedure TfrmPrincipal.UsaComprovantenoFiscalVinculadoTEF1Click(
  Sender: TObject);
begin
  frmUsaComprovanteNaoFiscalVinculado.Caption := 'Usa Comprovante Não Fiscal Vinculado TEF';
  frmUsaComprovanteNaoFiscalVinculado.ShowModal;
end;
...
begin
   ...
   Analisa_iRetorno();
   if iRetorno = 1 then
      Application.MessageBox( 'O arquivo RETORNO.TXT foi criado com sucesso!!!', 'Atenção', MB_IconInformation + MB_OK );
end;

procedure TfrmPrincipal.DownloadMFDMemriadeFitaDetalhe1Click(
  Sender: TObject);
begin
   frmDownload.Caption := 'Download MFD (Memória de Fita Detalhe)';
...
procedure TfrmPrincipal.DownloadMFMemriaFiscalImpressoraFiscalConv85Click(
  Sender: TObject);
begin
   frmDownload.Caption := 'Download MF (Memória Fiscal)';
...
procedure TfrmPrincipal.AtivaDesativaAlinhamentoEsquerdaMFDClick(
  Sender: TObject);
begin
   frmAtivaDesativaVendaUmaLinha.Caption := 'Ativa/Desativa Alinhamento à Esquerda MFD';
...
begin
   ...
   if ( iStatus >=  64 ) then begin iStatus := iStatus -  64; cMensagem := cMensagem + 'Estorno de Comprovante de Débito ou Crédito permitido' + #13 + #10; end;
   ...
   if ( iStatus >=   4 ) then begin iStatus := iStatus -   4; cMensagem := cMensagem + 'Relatório Gerencial Aberto' + #13 + #10;                            end;
   if ( iStatus >=   2 ) then begin iStatus := iStatus -   2; cMensagem := cMensagem + 'Comprovante de Débito ou Crédito Aberto' + #13 + #10;               end;
   if ( iStatus >=   1 ) then begin iStatus := iStatus -   1; cMensagem := cMensagem + 'Comprovante Não-Fiscal Aberto' + #13 + #10;                         end;

   if ( cMensagem = '' ) then
      Application.MessageBox( 'Sem Status !', 'Informação Impressora', MB_IconInformation + MB_OK )
   else
      Application.MessageBox( pchar( cMensagem ), 'Informação Impressora', MB_IconInformation + MB_OK );
...
begin
  ...
  Application.MessageBox( pchar( 'Tempo Restante para Cupom Aberto: ' + cTempoRestante ), 'Informação Impressora', MB_IconInformation + MB_OK );
...
begin
   ...
   Application.MessageBox( pchar( 'UF do Proprietário: ' + cUF ), 'Informação Impressora', MB_IconInformation + MB_OK );
...
begin
   ...
   Application.MessageBox( pchar( 'Grande Total da Última Redução Z: ' + cGT ), 'Informação Impressora', MB_IconInformation + MB_OK );
...
begin
   ...
   Application.MessageBox( pchar( 'Data do Movimento da Última Redução Z: ' + cData ), 'Informação Impressora', MB_IconInformation + MB_OK );
...
begin
   ...
   Application.MessageBox( pchar( 'Subtotal do Comprovante Não Fiscal: ' + cSubTotal ), 'Informação Impressora', MB_IconInformation + MB_OK );
...
begin
   ...
   Application.MessageBox( pchar( 'Valor do GT Inicial: ' + cGTInicial + #13 + 'Valor do GT Final: ' + cGTFinal ), 'Informação Impressora', MB_IconInformation + MB_OK );
...
begin
   ...
   Application.MessageBox( pchar( 'COO Inicial: ' + cCOOInicial + #13 + 'COO Final: ' + cCOOFinal ), 'Informação Impressora', MB_IconInformation + MB_OK );
...
begin
   ...
   Application.MessageBox( pchar( 'Flag de Corte: ' + inttostr( iFlag ) ), 'Informação Impressora', MB_IconInformation + MB_OK );
