object fNFPaulista: TfNFPaulista
  ...
  object sdsNF: TSQLDataSet
    CommandText = 
      ...
      '        nf.SELECIONOU '#13#10'from NOTAFISCAL nf '#13#10'inner join CLIENTES' +
      ' cl on cl.CODCLIENTE = nf.CODCLIENTE'#13#10'inner join enderecocliente' +
      ' endecli on endecli.CODCLIENTE = cl.CODCLIENTE'#13#10'where (nf.DTAEMI' +
