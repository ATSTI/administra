...
procedure TfAts_R.DoCustomDraw(Sender: TObject; ACanvas: TCanvas;
...
function TfAts_R.GetVersion: string;
var
  VerInfoSize: DWORD;
  VerInfo: Pointer;
  VerValueSize: DWORD;
...
function TfAts_R.NomeComputador: string;
const
  Max = 15;
var
...
procedure TfAts_R.FormCreate(Sender: TObject);
var
 vSaudacao : string;
begin
  JvOutlookBar1.OnCustomDraw := DoCustomDraw;
  //DM.MODULOUSERCONTROL := 'atsadmin';
  sCtrlResize.CtrlResize(TForm(fAts_R));
...
procedure TfAts_R.JvOutlookBar1Pages0Buttons0Click(Sender: TObject);
begin
...
procedure TfAts_R.FormShow(Sender: TObject);
...
procedure TfAts_R.FormClose(Sender: TObject; var Action: TCloseAction);
var
  X : Byte;
begin
...
procedure TfAts_R.StatusBar1DrawPanel(StatusBar: TStatusBar;
  Panel: TStatusPanel; const Rect: TRect);
begin
...
procedure TfAts_R.Timer1Timer(Sender: TObject);
begin
 StatusBar1.Panels[1].Text := TimetoStr(Time);
end;

procedure TfAts_R.JvOutlookBar1Pages1Buttons0Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages1Buttons1Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages2Buttons1Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages2Buttons0Click(Sender: TObject);
begin
  fcrTituloPagto.ShowModal;
end;

procedure TfAts_R.JvOutlookBar1Pages0Buttons4Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages0Buttons2Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages0Buttons3Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages5Buttons4Click(Sender: TObject);
begin
  Close;
end;

procedure TfAts_R.JvOutlookBar1Pages5Buttons0Click(Sender: TObject);
begin
  // teste
  // fAtsAdmin.Usuarios1.Click;
end;

procedure TfAts_R.JvOutlookBar1Pages5Buttons3Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages5Buttons2Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages5Buttons1Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages3Buttons0Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages3Buttons1Click(Sender: TObject);
begin
  fEntra_Sai_estoque := TfEntra_Sai_estoque.Create(Application);
 try
   with fEntra_Sai_estoque do
...
procedure TfAts_R.JvOutlookBar1Pages3Buttons2Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages3Buttons3Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages0Buttons5Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages2Buttons3Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages0Buttons6Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages4Buttons1Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages4Buttons2Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages4Buttons3Click(Sender: TObject);
begin
...
procedure TfAts_R.JvOutlookBar1Pages0Buttons7Click(Sender: TObject);
begin
