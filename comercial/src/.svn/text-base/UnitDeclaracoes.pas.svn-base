...
//function Bematech_FI_GeraRegistrosSpedCompleto( cArquivoMFD: string; cArquivoTXT: string; cDataInicial: string; cDataFinal: string; cPerfil: string; cCFOP: string; cCODOBSFiscal: string; cAliqPIS: string; cAliqCOFINS: string; cEmpresa: string; cCodMunicipio: string): Integer;  StdCall; External 'BEMAFI32.DLL';
