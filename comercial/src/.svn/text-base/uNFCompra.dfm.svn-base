object fNFCompra: TfNFCompra
  ...
  object PageControl1: TPageControl
    ...
    object tabitens: TTabSheet
      ...
      object Label29: TLabel
        ...
        Width = 101
        Height = 13
        Caption = 'Anota'#231#245'es / Controle'
      end
  ...
  object sNF: TSQLDataSet
    CommandText = 'select NOTAFISCAL from COMPRA'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
    Left = 164
    Top = 192
    object sNFNOTAFISCAL: TIntegerField
      FieldName = 'NOTAFISCAL'
    end
  end
  object dNF: TDataSetProvider
    DataSet = sNF
    UpdateMode = upWhereKeyOnly
    Left = 196
    Top = 192
  end
  object cNF: TClientDataSet
    Aggregates = <>
    Params = <>
    ProviderName = 'dNF'
    Left = 228
    Top = 192
    object cNFNOTAFISCAL: TIntegerField
      FieldName = 'NOTAFISCAL'
    end
  end
  object sds_nf: TSQLDataSet
    CommandText = 
      ...
      ':pvenda)) '#13#10' and NATUREZA = :nt'#13#10' '#13#10
    MaxBlobSize = -1
    Params = <
      item
        DataType = ftInteger
