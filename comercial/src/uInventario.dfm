inherited fInventario: TfInventario
  ...
  object Panel1: TPanel [2]
    ...
    object dxButton11: TdxButton
      ...
      Width = 52
      Height = 39
      Hint = 'Ajuda sobre o Invent'#225'rio'
  ...
  object Memo1: TMemo [4]
    ...
    Height = 393
    Lines.Strings = (
      'Para quem utiliza LOTES :'
      ''
      
        '    O Sistema ir'#225' pegar cada Lote, Produto, CCusto, e fazer o ac' +
        'erto'
      ' se necess'#225'rio do respectivo Lote;')
    TabOrder = 4
    Visible = False
  end
  ...
  object sqlEstoque: TSQLQuery
    ...
    SQL.Strings = (
        ...
        'select DISTINCT p.LOTE, p.MESANO, p.ESTOQUE AS SALDOESTOQUE  fro' +
        'm ESTOQUE_LOTE_ESTOQUEMES p '
      'where p.CODPRODUTO = :pProd '
      ' order by p.LOTE')
    SQLConnection = DM.sqlsisAdimin
    Left = 240
    Top = 241
