inherited fCest: TfCest
  Left = 366
  Top = 282
  Caption = 'Cadastro - CEST'
  OnShow = FormShow
  PixelsPerInch = 96
  TextHeight = 13
  inherited MMJPanel1: TMMJPanel
    ...
    object Label2: TLabel
      ...
      Width = 469
      Height = 23
      Caption = 'CEST - C'#243'digo Especificador da Substitui'#231#227'o Tribut'#225'ria'
  ...
  object sdsCest: TSQLDataSet
    CommandText = 'Select * from TAB_CEST'
    MaxBlobSize = -1
    Params = <>
    SQLConnection = DM.sqlsisAdimin
    Left = 280
    Top = 8
    object sdsCestCEST: TStringField
      FieldName = 'CEST'
      Required = True
      Size = 7
    end
    object sdsCestNCM: TStringField
      FieldName = 'NCM'
      Size = 8
    end
    object sdsCestDESCRICAO: TStringField
      FieldName = 'DESCRICAO'
      Size = 512
    end
  end
