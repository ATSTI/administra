inherited fEstoqueAjuste: TfEstoqueAjuste
  ...
  object sqlEstoque: TSQLQuery
    ...
    Left = 416
    Top = 192
    object sqlEstoqueCODPRODUTO: TIntegerField
      FieldName = 'CODPRODUTO'
      Required = True
    end
    ...
    object sqlEstoqueQTDEENTRADA: TFloatField
      FieldName = 'QTDEENTRADA'
    end
    object sqlEstoqueQTDECOMPRA: TFloatField
      FieldName = 'QTDECOMPRA'
    end
    object sqlEstoqueQTDEDEVCOMPRA: TFloatField
      FieldName = 'QTDEDEVCOMPRA'
    end
    object sqlEstoqueQTDESAIDA: TFloatField
      FieldName = 'QTDESAIDA'
    end
    object sqlEstoqueQTDEVENDA: TFloatField
      FieldName = 'QTDEVENDA'
    end
    object sqlEstoqueQTDEPERDA: TFloatField
      FieldName = 'QTDEPERDA'
    end
    object sqlEstoquePRECOCUSTO: TFloatField
      FieldName = 'PRECOCUSTO'
    end
    object sqlEstoquePRECOCOMPRA: TFloatField
      FieldName = 'PRECOCOMPRA'
    end
    object sqlEstoquePRECOCOMPRAULTIMA: TFloatField
      FieldName = 'PRECOCOMPRAULTIMA'
    end
    object sqlEstoquePRECOVENDA: TFloatField
      FieldName = 'PRECOVENDA'
    end
    object sqlEstoqueCENTROCUSTO: TIntegerField
      FieldName = 'CENTROCUSTO'
      Required = True
    end
    object sqlEstoqueQTDEDEVVENDA: TFloatField
      FieldName = 'QTDEDEVVENDA'
    end
    object sqlEstoqueQTDEINVENTARIO: TFloatField
      FieldName = 'QTDEINVENTARIO'
    end
    object sqlEstoqueSALDOMESANTERIOR: TFloatField
      FieldName = 'SALDOMESANTERIOR'
    end
