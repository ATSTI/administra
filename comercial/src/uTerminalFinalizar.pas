...
begin
  ...
  dm.scds_venda_proc.Params[0].AsInteger:= DM_MOV.c_movimentoCODMOVIMENTO.AsInteger;
...
begin
  ...
  cdsCODCLIENTE.AsInteger := DM_MOV.c_movimentoCODCLIENTE.AsInteger;
  cdsCODUSUARIO.AsInteger := DM_MOV.c_MovimentoCODUSUARIO.AsInteger;
  cdsNOMECLIENTE.AsString := DM_MOV.c_MovimentoNOMECLIENTE.AsString;
  cdsNOMEUSUARIO.AsString := DM_MOV.c_MovimentoNOMEUSUARIO.AsString;
  cdsVALOR.AsFloat := DM_MOV.c_movdetTotalPedido.Value;
  cdsDESCONTO.AsFloat := 0;
  cdsMULTA_JUROS.AsFloat := 0;
  cdsN_PARCELA.AsInteger := 1;
  cdsAPAGAR.AsFloat := DM_MOV.c_movdetTotalPedido.Value;
