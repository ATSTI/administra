...
begin
  if (edNota.Text = '') then
  begin
    MessageDlg('Digite o n˙mero da nota desejada, ou dÍ dois cliques nela.', mtWarning, [mbOK], 0);
    exit;
  end;
  ...
  begin
    ...
    begin
      ...
      begin
        MessageDlg('Este Cliente n„o consta no sistema, faÁa' +
      ...
      begin
        ...
        try
          ...
          begin
            ...
            if (cdsNFItemCODPRO_ATS.AsString = '') then
            begin
              MessageDlg('Existe Produto sem o CÛdigo no sistema.', mtWarning, [mbOK], 0);
...
begin
  ...
  begin
    MessageDlg('Marque a opÁ„o n„o enviadas, para prosseguir.', mtWarning, [mbOK], 0);
    exit;
  end;
